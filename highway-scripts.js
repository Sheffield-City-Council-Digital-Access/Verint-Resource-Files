...
function progressToForm() {
  ...
  window.location =
    "https://forms-sheffield.squiz.cloud/form/launch/" +
...
function vegetationFeatureSetHandler(marker, featureSet) {
  if (featureSet.features.length >= 1) {
    ...
    KDF.setVal(
      "grass_category",
      attributes["sheffield.corpmap.HCFP_Assets_GrassPlantArea.grass_category"]
    );

    if (
      attributes[
        "sheffield.corpmap.HCFP_Assets_GrassPlantArea.grass_category"
      ].startsWith("A")
    ) {
...
function finishInteraction() {
  ...
  if (
    ...
    KDF.setVal("txt_branch", "firstpoint");
    window.location =
      "https://forms-sheffield.squiz.cloud/form/launch/a_menu?branch=firstpoint" +
      agentparams;
  } else if (
    [
      "Burngreave",
    ...
    KDF.setVal("txt_branch", "page_hsgipmenu");
    window.location =
      "https://forms-sheffield.squiz.cloud/form/launch/hsg_menu?branch=page_hsgipmenu" +
      agentparams;
  } else if (
    KDF.getVal("le_channel") === "voice_in" &&
    KDF.getVal("txt_agentlocation") === "Contact Centre"
    ...
    window.location =
      "https://forms-sheffield.squiz.cloud/form/launch/hsg_menu?branch=page_hsgccmenu" +
      agentparams;
  } else {
    window.location =
      "https://forms-sheffield.squiz.cloud/form/launch/a_menu?" + agentparams;
  }
}
